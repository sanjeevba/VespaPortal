...
debugger; //Request - Insert
	...
	var oguid = sessionStorage.getItem('OccupationGuid');
	if (sessionStorage.getItem('OccupationGuidAppended') == 'false' && sessionStorage.getItem('Occupation Created') == 'true') {
		$('#liquid_form').attr('action', $('#liquid_form').attr('action')+ '&occupationguid='+oguid);
		// Only Append once
		sessionStorage.setItem('OccupationGuidAppended','true');
	}
    if (sessionStorage.getItem('Occupation Created') == true)  {
        $('#ees_portaloccupationattached').val(1);
    }
    ...
    sessionStorage.setItem('requestGuid',guid);
...
function trainingProviderType_OnChange() {
	if ($("#ees_trainingprovidertype_0").prop ("checked") )
	{
		companySpecificTraining(); 
	}
...
function companySpecificTraining() {
	// If populated, clear the ETPD ID field and display Training Provider fields.
	if ($("#ees_etplidnew").val() != "") {
		$("#ees_etplidnew").val("");
		showTrainingProviderFields();
	}
...
function hideTrainingProviderFields () {
	// Hide the fields.
	$("#ees_providername").closest("td").hide();
	$("#ees_providercontactfirstname").closest("td").hide();
	$("#ees_providercontactlastname").closest("td").hide();
	$("#ees_providercontactphone").closest("td").hide();
	$("#ees_providercontactemail").closest("td").hide();
...
function showTrainingProviderFields () {
	// Show the fields.
	$("#ees_providername").closest("td").show();
	$("#ees_providercontactfirstname").closest("td").show();
	$("#ees_providercontactlastname").closest("td").show();
	$("#ees_providercontactphone").closest("td").show();
	$("#ees_providercontactemail").closest("td").show();
}
