...
$('<input type="button" name="NextButton2" value="Confirm" onclick="updateStatusandType()" id="NextButton2" class="btn btn-primary button next submit-btn" nonactionlinkbutton="true">').insertAfter("#NextButton");
$("#NextButton").hide();
  _data = sessionStorage.getItem("grantAppData");
  data = JSON.parse(_data);
...
// Submitted //
    ...
    webapi.safeAjax({
      type: "PATCH",
      url: "/_api/ees_grantapplicants("+grantGuid+")",
